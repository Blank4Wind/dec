...
$('#infoForm').validator({
	fields : {
		'assistDetils.title' : 'required;',
		'assistDetils.content' : 'length[0~255, true];filter(\'<>/);',
		'assistDetils.sendTime':'required',
		'assistDetils.expireTime':'required',
		'assistDetils.state':'required',
	},
});
